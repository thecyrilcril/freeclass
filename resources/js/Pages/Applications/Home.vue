<template>
    <page-layout>
      <div class="flex">
        ...
        <div class="md:w-1/2 md:mt-12 md:ml-12">
          ...
          <p class="text-xl font-light pl-1 mb-2  leading-8">Yes! join our exclusively <span class="font-semibold">free*</span> hands-on pattern drafting training that will kick-start your fashion design career and equip you with the fundamentals of modern fashion design.</p>
          <p class="text-xl font-light pl-1 mb-3">Here are some of the things you will learn—</p>
          <div class="flex mb-3">
            <Bullet :class="'text-yellow-300'"></Bullet>
            <span class="font-light text-lg">The body anatomy and how it relates to fashion design.</span>
          </div>
          <div class="flex mb-3">
            <Bullet :class="'text-yellow-300'"></Bullet>
...
<!--           <div class="flex mb-3">
          ...
          <p class="text-lg font-light pl-1 mb-3 leading-8 font-medium">To participate in this training click on the register button below to apply you will be notified when selected.</p>

          <inertia-link :href="route('applicants.create')">
          <button :type="type" class="inline-flex items-center px-8 py-4 bg-pink-500 rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-purple-700 active:bg-purple-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-gray transition ease-in-out duration-150">Register if you live in Ilorin</button>
        </inertia-link>
